...
--
-- Host: classmysql.engr.oregonstate.edu    Database: cs340_kretzscd
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'cs340_kretzscd'
--
/*!50003 DROP FUNCTION IF EXISTS `mentorRole` */;
...
DELIMITER ;;
CREATE DEFINER=`cs340_kretzscd`@`%` FUNCTION `mentorRole`(m INT) RETURNS tinyint(1)
BEGIN
...
-- Dump completed on 2019-02-14  9:22:47
